...
• SQL queries? Check them out [SQL_Project_Data_Job_Analysis](https://github.com/Lightyear17/SQL_Project_Data_Job_Analysis).
...
- Visual Studio Code: My go-t for database
...
offering high salagies, showing a broad interest
...
specializations within data analvtics.

![Top Paying Roles](https://github.com/Lightyear17/SQL_Project_Data_Job_Analysis/blob/main/assets/top_paying_roles.png?raw=true)

*Bar graph visualizing the salary for the top 10
salaries for data analysts; ChatGPT generated this
graph from my SOL query results*
...
![Top Paying Skills](https://github.com/Lightyear17/SQL_Project_Data_Job_Analysis/blob/main/assets/top_skills.png?raw=true)
